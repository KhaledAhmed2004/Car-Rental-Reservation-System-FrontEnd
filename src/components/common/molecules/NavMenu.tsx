  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex flex-col md:flex-row gap-4">
        ...
        {token && (
          <motion.div key="dashboard" variants={linkVariants}>
            <NavLink
              to="/dashboard"
              className={({ isActive }) =>
                isActive
      ...
      <div className="md:hidden flex flex-col gap-4 bg-gray-200 p-4 rounded-lg">
        ...
        {/* Conditionally render the Dashboard link in mobile view */}
        {token && (
          <motion.div key="dashboard-mobile" variants={linkVariants}>
            <NavLink
              to="/dashboard"
              className={({ isActive }) =>
                isActive
